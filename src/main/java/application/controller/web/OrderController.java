...
//                order.setAddress(userEntity.getAddress());
    ...
    public String checkout(@Valid @ModelAttribute("order") OrderVM orderVM,
        ...
        if(flag == true) {
            ...
            order.setAddress_1(orderVM.getAddress_1());
            order.setAddress_2(orderVM.getAddress_2());
            order.setAddress_3(orderVM.getAddress_3());
            order.setAge(orderVM.getAge());
    ...
    public String orderHistory(Model model,
        ...
        if(orderEntityList != null) {
            for(Order order : orderEntityList) {
                ...
                orderVM.setAddress_1(order.getAddress_1());
                orderVM.setAddress_2(order.getAddress_2());
                orderVM.setAddress_3(order.getAddress_3());
                orderVM.setAge(order.getAge());
